...
matplotlib_logger.setLevel(logging.DEBUG)  # Define o nível de log para DEBUG ou outro nível desejado
...
pillow_logger.setLevel(logging.DEBUG)
...
# Disable debugging logs for matploblin
logging.getLogger('matplotlib').setLevel(logging.ERROR)

# same for the PIL logs
logging.getLogger('PIL').setLevel(logging.ERROR)

# same for the urllib3
